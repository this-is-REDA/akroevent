...
export default function MarqueeBand() {
  ...
  return (
    <div className="relative overflow-hidden border-y border-brand-red/50 bg-brand-secondary py-5">
      ...
      <div className="animate-marquee-fast flex w-max gap-16 whitespace-nowrap">
        {track.map((item, i) => (
          <span
            key={`${item}-${i}`}
            className="flex items-center gap-16 font-display text-base uppercase tracking-[0.3em] text-white/70 sm:text-lg"
          >
